...
> EnvRtype consists in three modules (sections 2 to 4), which collectively generate a simple workflow to collect, process and integrated envirotyping into genomic prediction in multiple environments.
